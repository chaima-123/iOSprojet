...
class BecomeProViewController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
       ...
       // btnValider.applyGradient(colours: [.purple, .systemPurple])
      //  btnValider.layer.masksToBounds = true
    ...
    @IBAction func btnSelectVille(_ sender: Any) {
        dataSource = ["Plombier", "Chauffagiste", "Eléctricien", "Ouvrier Climatisation"]
